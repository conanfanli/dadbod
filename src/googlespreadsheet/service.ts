...
class SheetService implements ISheetService {
  ...
  public get sheetId() {
    ...
    throw new Error("Sheet ID is not set");
  }
  ...
  public async getSheetName(): Promise<string> {
    return this._handle401(this.client.getSheetName(this.sheetId));
  }

  public async getRows() {
    return this._handle401(this.client.getRows(this.sheetId));
  }
}
